...
(function($) {
    var NivoSlider = function(element, options) {
        ...
        var createSlices = function(slider, settings, vars) {
            ...
            $('img[src="' + vars.currentImage.attr("src") + '"]', slider).not(".nivo-main-image,.nivo-control img")
                .width(slider.width()).css("visibility", "hidden").show();
            var sliceHeight =
                ($('img[src="' + vars.currentImage.attr("src") + '"]', slider).not(".nivo-main-image,.nivo-control img")
                        .parent().is("a"))
                ...
                for (var cols = 0; cols < settings.boxCols; cols++) {
                    if (cols === settings.boxCols - 1) {
                        ...
                        $('.nivo-box[name="' + cols + '"]', slider)
                            .height($('.nivo-box[name="' + cols + '"] img', slider).height() + "px");
                    } else {
                        slider.append(
                            $('<div class="nivo-box" name="' +
                                cols +
        ...
        var nivoRun = function(slider, kids, settings, nudge) {
            ...
            if (settings.effect === "random") {
                anims = new Array("sliceDownRight",
                    "sliceDownLeft",
                    "sliceUpRight",
                    "sliceUpLeft",
                    "sliceUpDown",
            ...
            if (currentEffect === "sliceDown" ||
                ...
                firstSlice.animate({ opacity: "1.0" },
