...
namespace ArshaHamrah.Areas.Admin.Pages.Products
{
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(IProductService productService, ITagService tagService, ICategoryService categoryService, IHostEnvironment environment,
            IKeywordService keywordService, IBrandService brandService, IDiscountService discountService, IStoreService storeService,
            ISupplierService supplierService, IImageService imageService, IHolooMGroupService holooMGroupService, IHolooSGroupService holooSGroupService,
