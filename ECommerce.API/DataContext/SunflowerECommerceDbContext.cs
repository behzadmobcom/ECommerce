...
new City { Id = 431, Name = "خاتم", StateId = 31 }
            ...
            modelBuilder.Entity<UserRole>().HasData(new UserRole { Id = 1, Name = "SuperAdmin", NormalizedName = "SUPERADMIN" });
        ...
        public SunflowerECommerceDbContext(DbContextOptions<SunflowerECommerceDbContext> options, IDataProtectionProvider dataProtectionProvider, IConfiguration configRoot) : base(options)
        {
