...
namespace API.Controllers
{
    ...
    public class SlideShowsController : ControllerBase
    {
        ...
        public SlideShowsController(ISlideShowRepository slideShowRepository, IPriceRepository priceRepository, ISettingRepository settingRepository, ILogger<SlideShowsController> logger)
        {
        ...
        public async Task<IActionResult> Get(CancellationToken cancellationToken)
        {
            try
            {
                ...
                foreach (var slideShow in slideShowViewModelList)
                {
                    ...
                    slideShow.Price = temp.FirstOrDefault(x => x.Currency.Name == currency && !x.IsColleague && x.MinQuantity == 1)?.Amount;
