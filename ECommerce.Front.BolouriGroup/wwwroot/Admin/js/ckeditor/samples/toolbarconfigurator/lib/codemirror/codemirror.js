(function(q) {
    ...
    function q(a, b) {
        ...
        Cd(this);
        this.state = { keyMaps: [], overlays: [], modeGen: 0, overwrite: !1, delayingBlurEvent: !1, focused: !1, suppressEdits: !1, pasteIncoming: !1, cutIncoming: !1, draggingText: !1, highlight: new bb, keySeq: null, specialChars: null };
        var e = this;
        B && 11 > C && setTimeout(function() { e.display.input.reset(!0) }, 20);
        sf(this);
        Dd || (tf(), Dd = !0);
        Ja(this);
    ...
    function Cc(a) { a.display.sizer.style.marginLeft = a.display.gutters.offsetWidth + "px" }

    function Kb(a) {
        if (0 == a.height)return 0;
        for (var b = a.text.length,
            c,
            d = a; c = Aa(d, !0);)c = c.find(0, !0), d = c.from.line, b += c.from.ch - c.to.ch;
    ...
    function Fc(a, b, c) {
        this.cm =
            c;
        var d = this.vert = t("div", [t("div", null, null, "min-width: 1px")], "CodeMirror-vscrollbar"), e = this.horiz = t("div", [t("div", null, null, "height: 100%; min-height: 1px")], "CodeMirror-hscrollbar");
        a(d);
        a(e);
        v(d, "scroll", function() { d.clientHeight && b(d.scrollTop, "vertical") });
    ...
    function Cd(a) {
        ...
        a.display.scrollbars = new q.scrollbarModel[a.options.scrollbarStyle](function(b) {
            ...
            v(b, "mousedown", function() { a.state.focused && setTimeout(function() { a.display.input.focus() }, 0) });
            b.setAttribute("cm-not-content", "true");
        }, function(b, c) { "horizontal" == c ? Ma(a, b) : lb(a, b) }, a);
    ...
    function Gd(a) {
        ...
        if (b.length != c.lineNumChars) {
            var d = c.measure.appendChild(t("div", [t("div", b)], "CodeMirror-linenumber CodeMirror-gutter-elt")), e = d.firstChild.offsetWidth, d = d.offsetWidth - e;
    ...
    function Jc(a, b) { return String(a.lineNumberFormatter(b + a.firstLineNumber)) }

    function Ic(a) { return a.scroller.getBoundingClientRect().left - a.sizer.getBoundingClientRect().left }
    ...
    function Nd(a) { if (a.widgets)for (var b = 0; b < a.widgets.length; ++b)a.widgets[b].height = a.widgets[b].node.offsetHeight }
    ...
    function Rc(a) { return r(a.line, a.ch) }

    function Pb(a, b) { return 0 > y(a, b) ? b : a }

    function Qb(a, b) { return 0 > y(a, b) ? a : b }

    function Ud(a) { a.state.focused || (a.display.input.focus(), xc(a)) }

    function Rb(a) { return a.options.readOnly || a.doc.cantEdit }
    ...
    function Sc(a, b, c, d, e) {
        ...
        for (var k = d.ranges.length - 1; 0 <= k; k--) {
            ...
            var n = a.curOp.updateInput, m = { from: m, to: p, text: h ? h[k % h.length] : g, origin: e || (a.state.pasteIncoming ? "paste" : a.state.cutIncoming ? "cut" : "+input") };
            Oa(a.doc, m);
            L(a, "inputRead", a, m);
    ...
    function Z(a, b) {
        var c = a[b];
        a.sort(function(a, b) { return y(a.from(), b.from()) });
        b = D(a, c);
        for (c = 1; c < a.length; c++) {
            var d = a[c], e = a[c - 1];
            if (0 <= y(e.to(), d.from())) {
                var f = Qb(e.from(), d.from()), g = Pb(e.to(), d.to()), d = e.empty() ? d.from() == d.head : e.from() == e.head;
                c <= b && --b;
    ...
    function ga(a, b) { return new la([new z(a, b || a)], 0) }
    ...
    function qb(a, b) { return b >= a.first && b < a.first + a.size }

    function rb(a, b, c, d) { return a.cm && a.cm.display.shift || a.extend ? (a = b.anchor, d && (b = 0 > y(c, a), b != 0 > y(d, a) ? (a = c, c = d) : b != 0 > y(c, d) && (c = d)), new z(a, c)) : new z(d || c, c) }

    function Ub(a, b, c, d) { H(a, new la([rb(a, a.sel.primary(), b, c)], 0), d) }
    ...
    function de(a, b) { b.equals(a.sel) || (a.sel = b, a.cm && (a.cm.curOp.updateInput = a.cm.curOp.selectionChanged = !0, fe(a.cm)), L(a, "cursorActivity", a)) }

    function ge(a) { de(a, ee(a, a.sel, null, !1), ha) }
    ...
    function nb(a) { a.display.input.showSelection(a.display.input.prepareSelection()) }
    ...
    function zf(a, b, c) {
        ...
        if (f.line == b.line)e(f.line, f.ch, b.ch);
            ...
            var p = u(g, f.line), k = u(g, b.line), k = ia(p) == ia(k), f = e(f.line, f.ch, k ? p.text.length + 1 : null).end;
    ...
    function fb(a, b) { a.doc.mode.startState && a.doc.frontier < a.display.viewTo && a.state.highlight.set(b, cb(Bf, a)) }
    ...
    function Ec(a) { return a.mover.offsetHeight - a.lineSpace.offsetHeight }

    function ie(a) {
        if (a.cachedPaddingH)return a.cachedPaddingH;
        var b = U(a.measure, t("pre", "x")), b = window.getComputedStyle ? window.getComputedStyle(b) : b.currentStyle, b = { left: parseInt(b.paddingLeft), right: parseInt(b.paddingRight) };
        isNaN(b.left) || isNaN(b.right) || (a.cachedPaddingH = b);
        return b;
    }

    function da(a) { return Hd - a.display.nativeBarWidth }

    function pa(a) { return a.display.scroller.clientWidth - da(a) - a.display.barWidth }

    function Nc(a) { return a.display.scroller.clientHeight - da(a) - a.display.barHeight }
    ...
    function Zd(a, b, c) {
        ...
        for (d = 0; d < a.rest.length; d++)if (F(a.rest[d]) > c)return{ map: a.measure.maps[d], cache: a.measure.caches[d], before: !0 };
    }
    ...
    function $c(a, b, c, d, e) {
        ...
        if (b.cache.hasOwnProperty(f))
            ...
            c = { left: ("right" == c ? n.right : n.left) - b.rect.left, right: ("left" == c ? n.left : n.right) - b.rect.left, top: m ? g[m - 1] : 0, bottom: g[m] };
    ...
    function le(a) { if (a.measure && (a.measure.cache = {}, a.measure.heights = null, a.rest))for (var b = 0; b < a.rest.length; b++)a.measure.caches[b] = {} }
    ...
    function Ja(a) {
        a.curOp = { cm: a, viewChanged: !1, startHeight: a.doc.height, forceUpdate: !1, updateInput: null, typing: !1, changeObjs: null, cursorActivityHandlers: null, cursorActivityCalled: 0, selectionChanged: !1, updateMaxLine: !1, scrollLeft: null, scrollTop: null, scrollToPos: null, focus: !1, id: ++Ff };
    ...
    function sf(a) {
        function b() { d.activeTouch && (e = setTimeout(function() { d.activeTouch = null }, 1E3), f = d.activeTouch, f.end = +new Date) }
        ...
        })) : v(d.scroller, "dblclick", function(b) { ja(a, b) || O(b) });
        id || v(d.scroller, "contextmenu", function(b) { qe(a, b) });
        var e, f = { end: 0 };
        v(d.scroller, "touchstart", function(a) {
            var b;
            1 != a.touches.length ? b = !1 : (b = a.touches[0], b = 1 >= b.radiusX && 1 >= b.radiusY);
            b || (clearTimeout(e), b = +new Date, d.activeTouch = { start: b, moved: !1, prev: 300 >= b - f.end ? f : null }, 1 == a.touches.length && (d.activeTouch.left = a.touches[0].pageX,
                d.activeTouch.top = a.touches[0].pageY));
        });
        v(d.scroller, "touchmove", function() { d.activeTouch && (d.activeTouch.moved = !0) });
        v(d.scroller, "touchend", function(e) {
            var f = d.activeTouch;
            if (f && !oa(d, e) && null != f.left && !f.moved && 300 > new Date - f.start) {
                var g = a.coordsChar(d.activeTouch, "page"), f = !f.prev || c(f, f.prev) ? new z(g, g) : !f.prev.prev || c(f, f.prev.prev) ? a.findWordAt(g) : new z(r(g.line, 0), w(a.doc, r(g.line + 1, 0)));
        ...
        v(d.scroller, "scroll",
            function() { d.scroller.clientHeight && (lb(a, d.scroller.scrollTop), Ma(a, d.scroller.scrollLeft, !0), K(a, "scroll", a)) });
        v(d.scroller, "mousewheel", function(b) { re(a, b) });
        v(d.scroller, "DOMMouseScroll", function(b) { re(a, b) });
        v(d.wrapper, "scroll", function() { d.wrapper.scrollTop = d.wrapper.scrollLeft = 0 });
        d.dragFunctions = {
        ...
        v(g, "keyup", function(b) { ue.call(a, b) });
        v(g, "keydown", G(a, ve));
        v(g, "keypress", G(a, we));
        v(g, "focus", cb(xc, a));
        v(g, "blur", cb(db, a));
    ...
    function oa(a, b) { for (var c = b.target || b.srcElement; c != a.wrapper; c = c.parentNode)if (!c || 1 == c.nodeType && "true" == c.getAttribute("cm-ignore-events") || c.parentNode == a.sizer && c != a.mover)return!0 }
    ...
    function pe(a) {
        ...
        if (!(b.activeTouch && b.input.supportsTouch() || ja(this, a)))
            if (b.shift = a.shiftKey, oa(b, a))J || (b.scroller.draggable = !1, setTimeout(function() { b.scroller.draggable = !0 }, 100));
                ...
                case 2:
                    ...
                    c && Ub(this.doc, c);
                    setTimeout(function() { b.input.focus() }, 20);
                    O(a);
                    break;
                case 3:
    ...
    function Nf(a, b, c, d, e) {
        ...
        function g(b) {
            ...
            if (e)
                if (0 != y(e, x)) {
                    ...
                    m && setTimeout(G(a, function() { A == c && (k.scroller.scrollTop += m, g(b)) }), 50);
                }
        }
        ...
        e ? -1 == p ? (p = q.length, H(l, Z(q.concat([m]), p), { scroll: !1, origin: "*mouse" })) : 1 < q.length && q[p].empty() && "single" == d && !b.shiftKey ? (H(l, Z(q.slice(0, p).concat(q.slice(p + 1)), 0)), n = l.sel) : Xc(l, p, m, kd) : (p = 0, H(l, new la([m], 0), kd), n = l.sel);
        var x = c,
            B = k.wrapper.getBoundingClientRect(),
            A = 0,
            F = G(a, function(a) { xe(a) ? g(a) : h(a) }),
            C = G(a, h);
        ...
        if (!ja(b, a) && !oa(b.display, a)) {
            ...
            if (c && !Rb(b))
                if (d && d.length && window.FileReader && window.File) {
                    ...
                    -1 < b.doc.sel.contains(c))b.state.draggingText(a), setTimeout(function() { b.display.input.focus() }, 20);
                else
                    try {
    ...
    function Ma(a, b, c) { (c ? b == a.doc.scrollLeft : 2 > Math.abs(a.doc.scrollLeft - b)) || (b = Math.min(b, a.display.scroller.scrollWidth - a.display.scroller.clientWidth), a.doc.scrollLeft = b, Bc(a), a.display.scroller.scrollLeft != b && (a.display.scroller.scrollLeft = b), a.display.scrollbars.setScrollLeft(b)) }
    ...
    function jc(a, b, c, d) {
        ...
        if (e) {
            ...
            Qf.set(50, function() { a.state.keySeq == e && (a.state.keySeq = null, a.display.input.reset()) });
            b = e + " " + b;
        }
        d = Of(a, b, d);
    ...
    function Be(a, b) {
        var c = Rf(b, !0);
        return c ? b.shiftKey && !a.state.keySeq ? jc(a, "Shift-" + c, b, function(b) { return hc(a, b, !0) }) || jc(a, c, b, function(b) { if ("string" == typeof b ? /^go[A-Z]/.test(b) : b.motion)return hc(a, b) }) : jc(a, c, b, function(b) { return hc(a, b) }) : !1;
    }

    function Sf(a, b, c) { return jc(a, "'" + c + "'", b, function(b) { return hc(a, b, !0) }) }
    ...
    function Tf(a) {
        function b(a) { 18 != a.keyCode && a.altKey || (kb(c, "CodeMirror-crosshair"), ka(document, "keyup", b), ka(document, "mouseover", b)) }
    ...
    function we(a) {
        if (!(oa(this.display, a) || ja(this, a) || a.ctrlKey && !a.altKey || W && a.metaKey)) {
            ...
            else if (!ba || a.which && !(10 > a.which) || !Be(this, a))if (b = String.fromCharCode(null == c ? b : c), !Sf(this, a, b))this.display.input.onKeyPress(a);
        }
    }

    function Kf(a) {
        a.state.delayingBlurEvent = !0;
        setTimeout(function() { a.state.delayingBlurEvent && (a.state.delayingBlurEvent = !1, db(a)) }, 100);
    }

    function xc(a) {
        a.state.delayingBlurEvent &&
        (a.state.delayingBlurEvent = !1);
        "nocursor" != a.options.readOnly && (a.state.focused || (K(a, "focus", a), a.state.focused = !0, mb(a.display.wrapper, "CodeMirror-focused"), a.curOp || a.display.selForContextMenu == a.doc.sel || (a.display.input.reset(), J && setTimeout(function() { a.display.input.reset(!0) }, 20)), a.display.input.receivedFocus()), Yc(a));
    }
    ...
    function Ee(a, b, c) { return a.line == b.line ? r(c.line, a.ch - b.ch + c.ch) : r(c.line + (a.line - b.line), a.ch) }

    function Fe(a, b, c) {
        b = { canceled: !1, from: b.from, to: b.to, text: b.text, origin: b.origin, cancel: function() { this.canceled = !0 } };
    ...
    function Oa(a, b, c) {
        ...
        if (c = Ge && !c && Uf(a, b.from, b.to))for (var d = c.length - 1; 0 <= d; --d)He(a, { from: c[d].from, to: c[d].to, text: d ? [""] : b.text });
        else He(a, b);
    }
    ...
    function Vf(a, b, c) {
        ...
        a.options.lineWrapping || (k = F(ia(u(d, f.line))), d.iter(k, g.line + 1, function(a) { if (a == e.maxLine)return h = !0 }));
        ...
        c = S(a, "changes");
        if ((d = S(a, "change")) || c)b = { from: f, to: g, text: b.text, removed: b.removed, origin: b.origin }, d && L(a, "change", a, b), c && (a.curOp.changeObjs || (a.curOp.changeObjs = [])).push(b);
    ...
    function mc(a) {
        ...
        if (b) {
            ...
            var c = oe(a, b.from), d = oe(a, b.to), b = cc(a, Math.min(c.left, d.left), Math.min(c.top, d.top) - b.margin, Math.max(c.right, d.right), Math.max(c.bottom, d.bottom) + b.margin);
    ...
    function x(a, b, c, d) {
        q.defaults[a] = b;
        c && (Ka[a] = d ? function(a, b, d) { d != Fd && c(a, b, d) } : c);
    }
    ...
    function pc(a) { return"string" == typeof a ? ua[a] : a }
    ...
    function Wa(a, b, c, d, e) {
        ...
        f.collapsed && a.iter(b.line,
            c.line + 1, function(b) { ya(a, b) && ca(b, 0) });
        f.clearOnEnter && v(f, "beforeCursorEnter", function() { f.clear() });
        ...
        if (h) {
            ...
            else if (f.className || f.title || f.startStyle || f.endStyle || f.css)for (d = b.line; d <= c.line; d++)na(h, d, "text");
            f.atomic && ge(h.doc);
            L(h, "markerAdded", h, f);
        }
        return f;
    ...
    function Re(a) { return a.findMarks(r(a.first, 0), a.clipPos(r(a.lastLine())), function(a) { return a.parent }) }

    function Yf(a) {
        for (var b = 0; b < a.length; b++) {
            var c = a[b], d = [c.primary.doc];
            Ga(c.primary.doc, function(a) { d.push(a) });
    ...
    function od(a, b) {
        ...
        var c = qb(a, b.from.line) && u(a, b.from.line).markedSpans, d = qb(a, b.to.line) && u(a, b.to.line).markedSpans;
        if (!c && !d)return null;
        ...
        c = k;
        if (d)for (var h = 0, n; h < d.length; ++h)if (k = d[h], l = k.marker, null == k.to || (l.inclusiveRight ? k.to >= f : k.to > f) || k.from == f && "bookmark" == l.type && (!g || k.marker.insertLeft))m = null == k.from || (l.inclusiveLeft ? k.from <= f : k.from < f), (n || (n = [])).push(new qc(l, m ? null : k.from - f, null == k.to ? null : k.to - f));
        d = n;
        g = 1 == b.text.length;
    ...
    function ya(a, b) {
        ...
        if (c)for (var d, e = 0; e < c.length; ++e)if (d = c[e], d.marker.collapsed && (null == d.from || !d.marker.widgetNode && 0 == d.from && d.marker.inclusiveLeft && td(a, b, d)))return!0;
    }
    ...
    function td(a, b, c) {
        ...
        for (var d, e = 0; e < b.markedSpans.length; ++e)if (d = b.markedSpans[e], d.marker.collapsed && !d.marker.widgetNode && d.from == c.to && (null == d.to || d.to != c.from) && (d.marker.inclusiveLeft || c.marker.inclusiveRight) && td(a, b, d))return!0;
    }
    ...
    function Ye(a, b, c, d) {
        function e(a) { return{ start: m.start, end: m.pos, string: m.current(), type: h || null, state: a ? Sa(f.mode, l) : l } }
    ...
    function je(a, b, c, d) {
        var e = [a.state.modeGen],
            f = {};
        Ze(a, b.text, a.doc.mode, c, function(a, b) { e.push(a, b) }, f, d);
    ...
    function Sd(a, b) {
        var c = t("span",
            ...
            c = { pre: t("pre", [c]), content: c, col: 0, pos: 0, cm: a, splitSpaces: (B || J) && a.getOption("lineWrapping") };
        b.measure = {};
    ...
    function Me(a, b) { return 0 == b.from.ch && 0 == b.to.ch && "" == A(b.text) && (!a.cm || a.cm.options.wholeLineUpdateBefore) }
    ...
    function qd(a, b, c, d) {
        ...
        var g = b.from, h = b.to, k = b.text, l = u(a, g.line), m = u(a, h.line), p = A(k), n = c ? c[k.length - 1] : null, q = h.line - g.line;
    ...
    function pd(a, b) {
        ...
        Ga(a, function(a) { cf(a, c, b.from.line, b.to.line + 1) }, !0);
        return c;
    }
    ...
    function df(a, b, c, d) { c < a.line ? a.line += d : b < a.line && (a.line = b, a.ch = 0) }
    ...
    function L(a, b) {
        function c(a) { return function() { a.apply(null, e) } }
    ...
    function ja(a, b, c) {
        "string" ==
            typeof b && (b = { type: b, preventDefault: function() { this.defaultPrevented = !0 } });
        K(a, c || b.type, a, b);
    ...
    function Ya(a) {
        ...
        a.prototype.off = function(a, c) { ka(this, a, c) };
    }
    ...
    function A(a) { return a[a.length - 1] }
    ...
    function oc(a, b) { return b ? -1 < b.source.indexOf("\\w") && gf(a) ? !0 : b.test(a) : gf(a) }
    ...
    function tb(a) { return 768 <= a.charCodeAt(0) && ig.test(a) }
    ...
    function U(a, b) { return za(a).appendChild(b) }

    function fa() { return document.activeElement }

    function Fb(a) { return new RegExp("(^|\\s)" + a + "(?:$|\\s)\\s*") }
    ...
    function dd(a) { return a.level % 2 ? a.to : a.from }

    function ed(a) { return a.level % 2 ? a.from : a.to }

    function ac(a) { return(a = Y(a)) ? dd(a[0]) : 0 }
    ...
    Gc.prototype = V({ update: function() { return{ bottom: 0, right: 0 } }, setScrollLeft: function() {}, setScrollTop: function() {}, clear: function() {} }, Gc.prototype);
    q.scrollbarModel = { "native": Fc, "null": Gc };
    Mb.prototype.signal = function(a, b) { S(a, b) && this.events.push(arguments) };
    Mb.prototype.finish =
        function() { for (var a = 0; a < this.events.length; a++)K.apply(null, this.events[a]) };
    var r = q.Pos = function(a, b) {
            if (!(this instanceof r))return new r(a, b);
            this.line = a;
            this.ch = b;
        },
        y = q.cmpPos = function(a, b) { return a.line - b.line || a.ch - b.ch },
        X = null;
    Tc.prototype = V({
        init: function(a) {
            function b(a) {
            ...
            v(f, "cut", b);
            v(f, "copy", b);
            v(a.scroller, "paste", function(b) { oa(a, b) || (d.state.pasteIncoming = !0, c.focus()) });
            v(a.lineSpace, "selectstart", function(b) { oa(a, b) || O(b) });
            ...
            v(f, "compositionend", function() { c.composing && (c.poll(), c.composing.range.clear(), c.composing = null) });
        },
        ...
        onContextMenu: function(a) {
            ...
            function c() {
                ...
                if (null != g.selectionStart) {
                    (!B || B && 9 > C) && b();
                    var a = 0, c = function() { f.selForContextMenu == e.doc.sel && 0 == g.selectionStart && 0 < g.selectionEnd && "​" == d.prevInput ? G(e, ic.selectAll)(e) : 10 > a++ ? f.detectingSelectAll = setTimeout(c, 500) : f.input.reset() };
    ...
    Uc.prototype = V({
        init: function(a) {
            ...
            v(a, "compositionupdate", function(a) { c.composing.data = a.data });
            ...
            v(a, "touchstart", function() { c.forceCompositionEnd() });
            v(a, "input", function() { c.composing || c.pollContent() || T(c.cm, function() { Q(d) }) });
            v(a, "copy", b);
            v(a, "cut", b);
        },
        prepareSelection: function() {
        ...
        startGracePeriod: function() {
            ...
            this.gracePeriod = setTimeout(function() {
                a.gracePeriod = !1;
                a.selectionChanged() && a.cm.operation(function() { a.cm.curOp.selectionChanged = !0 });
            }, 20);
        },
        ...
        receivedFocus: function() {
            ...
            var b = this;
            this.selectionInEditor() ? this.pollSelection() : T(this.cm, function() { b.cm.curOp.selectionChanged = !0 });
    ...
    z.prototype = { from: function() { return Qb(this.anchor, this.head) }, to: function() { return Pb(this.anchor, this.head) }, empty: function() { return this.head.line == this.anchor.line && this.head.ch == this.anchor.ch } };
    ...
    var Qf = new bb, md = null, ta = q.changeEnd = function(a) { return a.text ? r(a.from.line + a.text.length - 1, A(a.text).length + (1 == a.text.length ? a.from.ch : 0)) : a.to };
    q.prototype = {
        constructor: q,
        focus: function() {
            window.focus();
        ...
        moveH: M(function(a, b) {
            var c = this;
            c.extendSelectionsBy(function(d) { return c.display.shift || c.doc.extend || d.empty() ? rd(c.doc, d.head, a, b, c.options.rtlMoveVisually) : 0 > a ? d.from() : d.to() }, Gb);
        }),
        ...
        findWordAt: function(a) {
            ...
            if (b) {
                ...
                for (var f = b.charAt(c), f = oc(f, e) ? function(a) { return oc(a, e) } : /\s/.test(f) ? function(a) { return/\s/.test(a) } : function(a) { return!/\s/.test(a) && !oc(a) }; 0 < c && f(b.charAt(c - 1));)--c;
        ...
        scrollIntoView: M(function(a, b) {
            null == a ? (a = { from: this.doc.sel.primary().head, to: null }, null == b && (b = this.options.cursorScrollMargin)) : "number" == typeof a ? a = { from: r(a, 0), to: null } : null == a.from && (a = { from: a, to: null });
            a.to || (a.to = a.from);
            a.margin = b || 0;
    ...
    Ya(q);
    var qf = q.defaults = {}, Ka = q.optionHandlers = {}, Fd = q.Init = { toString: function() { return"CodeMirror.Init" } };
    x("value", "", function(a, b) { a.setValue(b) }, !0);
    ...
    x("electricChars", !0);
    x("inputStyle", ab ? "contenteditable" : "textarea", function() { throw Error("inputStyle can not (yet) be changed in a running editor"); }, !0);
    ...
    x("coverGutterNextToScrollbar", !1, function(a) { Na(a) }, !0);
    ...
    x("lineNumberFormatter", function(a) { return a }, ib, !0);
    x("showCursorWhenSelecting", !1, nb, !0);
    x("resetSelectionOnContextMenu", !0);
    x("lineWiseCopyCut", !0);
    x("readOnly", !1, function(a, b) { "nocursor" == b ? (db(a), a.display.input.blur(), a.display.disabled = !0) : (a.display.disabled = !1, b || a.display.input.reset()) });
    x("disableInput", !1, function(a, b) { b || a.display.input.reset() }, !0);
    ...
    x("pollInterval", 100);
    x("undoDepth", 200, function(a, b) { a.doc.history.undoDepth = b });
    x("historyEventDelay",
        1250);
    x("viewportMargin", 10, function(a) { a.refresh() }, !0);
    x("maxHighlightLength", 1E4, eb, !0);
    x("moveInputWithCursor", !0, function(a, b) { b || a.display.input.resetPosition() });
    x("tabindex", null, function(a, b) { a.display.input.getField().tabIndex = b || "" });
    x("autofocus", null);
    ...
    q.defineMIME = function(a, b) { Hb[a] = b };
    q.resolveMode =
        function(a) {
    ...
    q.defineMode("null", function() { return{ token: function(a) { a.skipToEnd() } } });
    ...
    q.defineExtension = function(a, b) { q.prototype[a] = b };
    ...
    q.defineOption = x;
    var yc = [];
    q.defineInitHook = function(a) { yc.push(a) };
    var $a = q.helpers = {};
    ...
    q.fromTextArea = function(a, b) {
        ...
        var k = q(function(b) { a.parentNode.insertBefore(b, a.nextSibling) }, b);
        return k;
    };
    ...
    tc.prototype = {
        ...
        match: function(a, b, c) {
            if ("string" == typeof a) {
                var d = function(a) { return c ? a.toLowerCase() : a }, e = this.string.substr(this.pos, a.length);
    ...
    rc.prototype.find = function(a, b) { return this.primary.find(a, b) };
    ...
    Ya(Ab);
    Ab.prototype.lineNo = function() { return F(this) };
    var bg = {}, ag = {};
    Bb.prototype = {
    ...
    P.prototype = ff(Cb.prototype, {
        ...
        historySize: function() {
            for (var a =
                ...
                b = 0,
                c = 0,
                d = 0; d < a.done.length; d++)a.done[d].ranges || ++b;
        ...
        indexFromPos: function(a) {
            ...
            this.iter(this.first, a.line, function(a) { b += a.text.length + 1 });
            return b;
        },
        copy: function(a) {
    ...
    for (Jb in P.prototype)P.prototype.hasOwnProperty(Jb) && 0 > D(pg, Jb) && (q.prototype[Jb] = function(a) { return function() { return a.apply(this.doc, arguments) } }(P.prototype[Jb]));
    Ya(P);
    var O = q.e_preventDefault = function(a) { a.preventDefault ? a.preventDefault() : a.returnValue = !1 },
        qg = q.e_stopPropagation = function(a) { a.stopPropagation ? a.stopPropagation() : a.cancelBubble = !0 },
        ...
        Db =
            null,
        Hd = 30,
        Ae = q.Pass = { toString: function() { return"CodeMirror.Pass" } },
        ha = { scroll: !1 },
        kd = { origin: "*mouse" },
        Gb = { origin: "+move" };
    ...
    var rg = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/,
        gf = q.isWordChar = function(a) { return/\w/.test(a) || "" < a && (a.toUpperCase() != a.toLowerCase() || rg.test(a)) },
