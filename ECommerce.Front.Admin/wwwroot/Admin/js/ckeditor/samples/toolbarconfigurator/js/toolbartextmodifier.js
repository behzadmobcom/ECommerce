(function() {
    ...
    e.prototype._createModifier = function(a) {
        ...
        function b(a) {
            setTimeout(function() { a.state.completionActive || CodeMirror.showHint(a, d, { hintsClass: "toolbar-modifier", completeSingle: !1 }) }, 100);
    ...
    e.prototype._mapToolbarSubgroup = function(a, d) {
        ...
        for (var f = a.groups ? a.groups.length : 0, c = [], b = 0; b < f; b += 1) {
            var e = a.groups[b], e = this.fullToolbarEditor.buttonsByGroup["string" === typeof e ? e : e.name] || [], e = this._mapButtonsToButtonsNames(e, d), g = e.length, c = c.concat(e);
            g && c.push("-");
        }
        "-" == c[c.length - 1] && c.pop();
        return c;
