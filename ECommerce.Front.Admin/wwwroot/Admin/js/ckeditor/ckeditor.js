...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return{
            ...
            on: function(b, d, g, k, l) {
                function q(a, f, y, l) {
                    a = { name: b, sender: this, editor: a, data: f, listenerData: k, stop: y, cancel: l, removeListener: v };
            ...
            fire: function() {
                var a = 0, b = function() { a = 1 }, g = 0, k = function() { g = 1 };
    ...
    CKEDITOR.dom = {};
    (function() {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, l = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: "\"", nbsp: " ", shy: "­" }, q = function(a, f) { return"#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : l[f] };
        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function(a) {
                ...
                for (var f,
                    b = [],
                    c = 0; c < a.length; c++)if (f = a[c])/@import|[{}]/.test(f) ? b.push("\x3cstyle\x3e" + f + "\x3c/style\x3e") : b.push("\x3clink type\x3d\"text/css\" rel\x3dstylesheet href\x3d\"" + f + "\"\x3e");
                return b.join("");
            },
            htmlEncode: function(a) { return void 0 === a || null === a ? "" : String(a).replace(b, "\x26amp;").replace(c, "\x26gt;").replace(e, "\x26lt;") },
            htmlDecode: function(a) { return a.replace(k, q) },
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var n = "\x3c" + l + "\x3e", q = "\x3c/" + l + "\x3e", c = n + c.replace(d, function() { return q + n }) + q;
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function w(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0 }
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return(!b || !F.equals(a)) && (!g || !a.equals(g)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) };
            }
            var k = a ? this._.guardRTL : this._.guardLTR;
            t = h ? function(a, b) { return!1 === k(a, b) ? !1 : h(a, b) } : k;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(), l = CKEDITOR.dom.walker.temp(), q = function(a) { return k(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) };
    ...
    (function() {
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                ...
                return function(c) {
                    var d = this.collapsed, e = { container: this.startContainer, offset: this.startOffset }, g = { container: this.endContainer, offset: this.endOffset };
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        ...
                        h.evaluator = function(a) { return!G(a) && !K(a) };
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) {
                    for (var c = this.createBookmark(),
                        ...
                        e = d.block ||
                            d.blockLimit,
                        g; e && !e.equals(d.root) && !e.getFirst(a(e));)g = e.getParent(), this[b ? "setEndAt" : "setStartAt"](e, CKEDITOR.POSITION_AFTER_END), e.remove(1), e = g;
                    this.moveToBookmark(c);
                };
            }(),
            ...
            moveToClosestEditablePosition: function(a, b) {
                ...
                if (a && !a.is(CKEDITOR.dtd.$block))d = 1;
                    ...
                    d = 1, (n = e.type == CKEDITOR.NODE_ELEMENT) &&
    ...
    (function() {
        ...
        function b(a, c, e, g) {
            ...
            if (!g)return 0;
            if ((k = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !k.check(c))
                return b(a,
                    c, e, g.remaining);
    ...
    (function() {
        ...
        function r(a, b, h, e) {
            ...
            if (e.doFilter) {
                a: {
                    ...
                    x = e.skipRequired;
                    var F = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 }, k, C;
                    if (a || f) {
                        A(b);
                        if (g)
        ...
        function z(a) { return function(b) { return m(b, a) } }

        function F(a) { return function(b, c) { c[a](b) } }
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                var p = this, e = [], m = this.editor && this.editor.config.protectedSource, f, g = !1, n = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                ...
                for (; t = a.pop();)
                    if (c = t.el, c.parent)
                        switch (x = B[c.parent.name] || B.span, t.check) {
                        case "it":
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (e = 0; e < b.length; ++e)
                            m = b[e], "string" == typeof m ? (m = m.split(/\s*:\s*/), f = m[0], g = null, t = m[1]) : (f = m.check, g = m.left, t = m.right), p || (p = m, p = p.element ? p.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
        ...
        J = CKEDITOR.filter.transformationsTools = {
            ...
            transform: function(a, b) {
                if ("string" == typeof b)a.name = b;
                    ...
                    a.name = c.element;
                    for (p in h)
                        if ("class" == p)for (c = a.classes.join("|"), m = h[p].split(/\s+/); f = m.pop();)-1 == c.indexOf(f) && a.classes.push(f);
    ...
    CKEDITOR.scriptLoader = function() {
        ...
        return{
            load: function(b, c, e, g) {
                ...
                k && (b = [b]);
                e || (e = CKEDITOR);
                var l = b.length, q = [], v = [], f = function(a) { c && (k ? c.call(e, a) : c.call(e, q, v)) };
                if (0 === l)f(!0);
                else {
                    var y = function(a, b) {
                            (b ? q : v).push(a);
                        ...
                        r = function(b) {
                            if (a[b])y(b, !0);
                                ...
                                if (!(1 < e.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && 8 >= CKEDITOR.env.version ? f.$.onreadystatechange = function() { if ("loaded" == f.$.readyState || "complete" == f.$.readyState)f.$.onreadystatechange = null, A(b, !0) } : (f.$.onload = function() { setTimeout(function() { A(b, !0) }, 0) }, f.$.onerror = function() { A(b, !1) }));
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            setKeystroke: function() {
                for (var a = this.keystrokeHandler.keystrokes,
                    b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [
                        [].slice.call(arguments,
                            0)
                    ],
                    c,
                    d,
                    e = b.length; e--;)c = b[e], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d : delete a[c];
            },
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            ...
            getAscendant: function(a) {
                var d = "function" == typeof a ? a : "string" == typeof a ? function(b) { return b.name == a } : function(b) { return b.name in a }, b = this.parent;
                for (; b &&
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, k, l) {
                ...
                function v() { for (; H.length;)y(H.shift(), u) }
                ...
                function r(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 }
    ...
    (function() {
        ...
        function v(a) {
            return a.replace(F,
                function(a, b, c) { return"\x3c" + b + c.replace(B, function(a, b) { return E.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" });
        }
        ...
        function y(a) { return a.replace(O, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function r(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function n(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, h) { return"\x3c" + c + d + "\x3e" + D(r(h), b) + "\x3c/" + c + "\x3e" });
        }
        ...
        var w = /(?:&nbsp;|\xa0)$/,
            ...
            m = { attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]] },
            x = {
                elements: {
                    embed: function(a) {
                        var b = a.parent;
    ...
    (function() {
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
            ...
            k = k ? this.container.getFirst(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : l;
            k.setSize("width", a, !0);
            v && (v.style.width = "1%");
    ...
    (function() {
        function a(a) {
            ...
            k(b, e.block, m) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), m = new CKEDITOR.dom.walker(e), m.guard = function(a) { return!c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !m.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElement: function(a, b) {
                    ...
                    b || (b = d.getRanges()[0]);
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) { return c(a) && !r(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0,
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var g, k;
                    if (f)
                        for (; (g = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[g.getName()]) &&
                ...
                setup: function() {
                    ...
                    this.attachListener(a,
                        "afterSetData", function() { this.setData(a.getData(1)) }, this);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        CKEDITOR.env.edge &&
                            this.attachListener(this, "mouseup", function(b) { (b = b.data.getTarget()) && b.is("img") && a.getSelection().selectElement(b) });
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
                            ...
                            if (b in l) {
                                ...
                                if (d.collapsed)
                                    ...
                                    c = d, f = b.block, d = c.endPath().block, f && d && !f.equals(d) ? (a.fire("saveSnapshot"), (h = f.getBogus()) && h.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE),
        ...
        n = function() {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var k = B[k.getName()], x = 0, l = c.getChildren(), F = l.count(), z = -1, n = -1, q = 0, v = e.contains(B.$list); x < F; ++x)
                    e = l.getItem(x), a(e) ? (m = e.getName(), v && m in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (p = !!k[m], "br" != m || !e.data("cke-eol") || x && x != F - 1 || (q = (f = x ? g[x - 1].node : l.getItem(x + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && B.$block[f.getName()]), -1 != z || p || (z = x), p || (n = x), g.push({
                        isElement: 1,
                        isLineBreak: q,
            ...
            var B = CKEDITOR.dtd, n = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, q = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, v = CKEDITOR.tools.extend({}, B.$inline);
            delete v.br;
            return function(n, E, C, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    if (L = C) {
                        ...
                        if ((A = L.startPath().block) && (1 != A.getChildCount() || !A.getBogus()))
                            a: {
                                var y;
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({ tr: 1, table: 1 })) {
                        ...
                        g = function(a) { return!a.equals(l) };
                    }
                ...
                list: {
                    detectMerge: function(a, b) {
                        ...
                        if (a.mergeList || a.mergeListItems)
                            d = d.clone(), d.setStartBefore(a.bookmark.startNode),
                ...
                table: function() {
                    ...
                    return{
                        ...
                        detectRanges: function(e, f) {
                            ...
                            l = l.contains("table");
                            if (n || l)
                                n && l && b(n, l) ? (e.tableSurroundingRange = g, g.setStartAt(n, CKEDITOR.POSITION_AFTER_END), g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), g = h.clone(), g.setEndAt(n, CKEDITOR.POSITION_AFTER_END), k = h.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), k = a(g).concat(a(k))) : n ? l || (e.tableSurroundingRange = g, g.setStartAt(n, CKEDITOR.POSITION_AFTER_END), h.setEndAt(n,
    ...
    (function() {
        ...
        function c(a) { return r(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 }
        ...
        function l(a, b) { return b ? a.replace(t, function(a, b) { return b ? " " : "" }) : a.replace(u, "") }
        ...
        function q(a, b) {
            ...
            a.fire("lockSnapshot");
            a.editable().append(c);
            var d = a.getSelection(1), e = a.createRange(), f = d.root.on("selectionchange", function(a) { a.cancel() }, null, null, 0);
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                if (CKEDITOR.env.ie || q)
                    n ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
                        e.lockSelection(C);
                        r = 1;
        ...
        var H = { img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1 }, u = CKEDITOR.tools.repeat("​", 7), t = new RegExp(u + "( )?", "g");
                        ...
                        if (d == CKEDITOR.SELECTION_ELEMENT) {
                            for (var d = [], e = 0; e < c.length; e++) {
                                for (var f =
                                    ...
                                    h = f.parentNode,
                                    g = 0,
                                    a = new CKEDITOR.dom.range(this.root); g < h.childNodes.length && h.childNodes[g] != f; g++);
                    ...
                    if (this.isLocked) {
                        ...
                        if (l)this.fake(l);
                            ...
                            if (n) {
                                ...
                                a = l.collapsed;
                                var r, u, t;
                                if ((c = l.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in H && (!c.is("a") || !c.getText()))
                                    try {
                ...
                for (r.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (l && t && !t.collapsed) {
                        for (var l = H(this, f), u = l.hasAttributes(), w = t.getCommonAncestor(), y = {}, x = {}, z = {}, B = {}, S, V, ca; l && w;) {
                            if (w.getName() == g) {
                                for (S in h.attributes)
                                    !B[S] && (ca = w.getAttribute(V)) &&
...
*/
                    ...
                    if (!(4 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, e, function() {
                            ...
                            "horizontal" != a.labelLayout ? e.push("\x3clabel class\x3d\"cke_dialog_ui_labeled_label" + g + "\" ", " id\x3d\"" + c.labelId + "\"", c.inputId ? " for\x3d\"" + c.inputId + "\"" : "", (a.labelStyle ? " style\x3d\"" + a.labelStyle + "\"" : "") + "\x3e", a.label, "\x3c/label\x3e", "\x3cdiv class\x3d\"cke_dialog_ui_labeled_content\"",
                                ...
                                padding: 0,
                                children: [
                                    { type: "html", html: "\x3clabel class\x3d\"cke_dialog_ui_labeled_label" + g + "\" id\x3d\"" + c.labelId + "\" for\x3d\"" + c.inputId + "\"" + (a.labelStyle ? " style\x3d\"" + a.labelStyle + "\"" : "") + "\x3e" + CKEDITOR.tools.htmlEncode(a.label) + "\x3c/label\x3e" }, {
                                        type: "html",
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this,
                            b, a, d, function() {
                                for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", k = 0; k < a.items.length; k++) {
                                    var l = a.items[k], h = void 0 !== l[2] ? l[2] : l[0], n = void 0 !== l[1] ? l[1] : l[0], p = CKEDITOR.tools.getNextId() + "_radio_input", q = p + "_label", p = CKEDITOR.tools.extend({}, a, { id: p, title: null, type: null }, !0), h = CKEDITOR.tools.extend({}, p, { title: h }, !0), r = { type: "radio", "class": "cke_dialog_ui_radio_input", name: g, value: n, "aria-labelledby": q }, u = [];
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, q, {
                ...
                reset: function() {
                    function b() {
                        ...
                        d.$.write([
                            "\x3chtml dir\x3d\"" + g + "\" lang\x3d\"" + k + "\"\x3e\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e\x3cbody style\x3d\"margin: 0; overflow: hidden; background: transparent;\"\x3e", "\x3cform enctype\x3d\"multipart/form-data\" method\x3d\"POST\" dir\x3d\"" + g + "\" lang\x3d\"" + k + "\" action\x3d\"", CKEDITOR.tools.htmlEncode(f.action), "\"\x3e\x3clabel id\x3d\"", a.labelId, "\" for\x3d\"", h, "\" style\x3d\"display:none\"\x3e", CKEDITOR.tools.htmlEncode(f.label),
    ...
    (function() {
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            this.on("iframeAdded", function(a) { (new CKEDITOR.dom.document(a.data.iframe.$.contentWindow.document)).on("keydown", e, this, null, 0) });
            this.on("show", function() {
                c();
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    for (var b = [],
                        ...
                        d = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, { type: "vbox", className: "cke_dialog_page_contents", children: a.elements, expand: !!a.expand, padding: a.padding, style: a.style || "width: 100%;" }, b),
                    ...
                    c = CKEDITOR.dom.element.createFromHtml([
                        "\x3ca class\x3d\"cke_dialog_tab\"", 0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? " style\x3d\"display:none\"" : "", " id\x3d\"", e, "\"", d.gecko && !d.hc ? "" : " href\x3d\"javascript:void(0)\"",
        ...
        var J,
            ...
            S = function(a, b, c, d, e) { (w[c] || (w[c] = [])).push({ uiElement: a, dialog: b, key: c, keyup: e || a.accessKeyUp, keydown: d || a.accessKeyDown }) },
            ba = function(a) {
                for (var b in w) {
        ...
        CKEDITOR.ui.dialog.uiElement.prototype = {
            ...
            registerEvents: function(a) {
                var b = /^on([A-Z]\w+)/, c, d = function(a, b, c, d) { b.on("load", function() { a.getInputElement().on(c, d, a) }) }, e;
                for (e in a)
                    if (c =
        ...
        function y(b) {
            function a() {
                ...
                a.attachListener(CKEDITOR.env.ie ?
                    a : b.document.getDocumentElement(), "mouseup", function() { c = setTimeout(function() { t() }, 0) });
            ...
            function f(a) {
                var d = b.document, c = d.getBody(), e = !1, f = function() { e = !0 };
                c.on(a, f);
            ...
            function k(a) {
                ...
                c && n.canClipboardApiBeTrusted(d.dataTransfer, b) ? (a.data.preventDefault(), setTimeout(function() { r(b, d) }, 0)) : l(a, function(a) {
            ...
            b.on("contentDom", function() {
                ...
                f.attachListener(b, "drop", function(e) {
                    if (e = e.data) {
                        ...
                        h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL ? setTimeout(function() { a.internalDrop(g, f, h, b) }, 0) : h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c(g, f, h) : d(f, h);
                    }
                }, null, null, 9999);
            });
        }
        ...
        CKEDITOR.plugins.add("clipboard", {
            ...
            init: function(b) {
                ...
                b.on("paste", function(a) {
                    ...
                    -1 < b.indexOf("Apple-") && (b = b.replace(/<span class="Apple-converted-space">&nbsp;<\/span>/gi, " "), "html" != a.data.type && (b = b.replace(/<span class="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi, function(a, b) { return b.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;") })), -1 < b.indexOf("\x3cbr class\x3d\"Apple-interchange-newline\"\x3e") &&
                    ...
                    CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function(b,
                        f) { return f.toLowerCase() in c ? (a.data.preSniffing = "html", "\x3c" + f) : b }) : CKEDITOR.env.webkit ? b = b.replace(/<\/(\w+)><div><br><\/div>$/, function(b, f) { return f in c ? (a.data.endsWithEOL = 1, "\x3c/" + f + "\x3e") : b }) : CKEDITOR.env.gecko && (b = b.replace(/(\s)<br>$/, "$1"));
                    a.data.dataValue = b;
                }, null, null, 3);
                b.on("paste", function(a) {
                    a = a.data;
            ...
            fixSplitNodesAfterDrop: function(b, a, c, d) {
                function e(b, c, d) {
                    ...
                    if (e.equals(c) && d != c.getChildCount())
                        return b = a.startContainer.getChild(a.startOffset - 1), c = a.startContainer.getChild(a.startOffset), b && b.type == CKEDITOR.NODE_TEXT &&
                    ...
                    b = CKEDITOR.tools.addFunction(function(a, b) {
                        ...
                        if ("?" == a)
                            ...
                            if (a) {
                                ...
                                f.childRule = "back" == b ? function(a) { return t(a) } : function(a) {
    ...
    (function() {
        ...
        CKEDITOR.loadTemplates = function(a, d) {
            for (var e =
                     [],
                b = 0,
                c = a.length; b < c; b++)f[a[b]] || (e.push(a[b]), f[a[b]] = 1);
    ...
    (function() {
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function(a, b) {
                ...
                var c = CKEDITOR.tools.extend({}, b.panel, { css: [CKEDITOR.skin.getPath("editor")], level: this._.level - 1, block: {} }), m = c.block.attributes = c.attributes || {};
                !m.role && (m.role = "menu");
            ...
            init: function(a) {
                if (!a.blockless) {
                    ...
                    a.addCommand("removediv", {
                        requiredContent: "div",
                        exec: function(a) {
                            function c(b) { (b = CKEDITOR.plugins.div.getSurroundDiv(a, b)) && !b.data("cke-div-added") && (f.push(b), b.data("cke-div-added")) }
    ...
    (function() {
        ...
        var y = { toolbarFocus: { editorFocus: !1, readOnly: 1, exec: function(a) { (a = CKEDITOR.document.getById(a._.elementsPath.idBase + "0")) && a.focus(CKEDITOR.env.ie || CKEDITOR.env.air) } } }, d = "";
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("fakeobjects", { init: function(a) { a.filter.allow("img[!data-cke-realelement,src,alt,title](*){*}", "fakeobjects") }, afterInit: function(a) { (a = (a = a.dataProcessor) && a.htmlFilter) && a.addRules(m, { applyToAll: !0 }) } });
            ...
            a.ui.addRichCombo(b, {
                ...
                onClick: function(b) {
                    ...
                    if (c && b != c) {
                        ...
                        if (e.collapsed) {
                            var d = a.elementPath(), g = d.contains(function(a) { return k.checkElementRemovable(a) });
                            if (g) {
                ...
                setData: function(a, f) {
                    ...
                    if (f)this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady");
                        ...
                        try {
                            ...
                            setTimeout(function() { k.write(a) }, 0);
                        }
                    }
                },
                getData: function(a) {
    ...
    (function() {
        ...
        var v = { ol: 1, ul: 1 }, K = CKEDITOR.dom.walker.whitespaces(), H = CKEDITOR.dom.walker.bookmark(), u = function(b) { return!(K(b) || H(b)) }, z = CKEDITOR.dom.walker.bogus();
    ...
    (function() {
        ...
        function la(a) {
            ...
            v(d, {
                ...
                lineChildren: [
                    v(G("\x3cspan title\x3d\"" + a.editor.lang.magicline.title + "\" contenteditable\x3d\"false\"\x3e\x26#8629;\x3c/span\x3e", c), {
        ...
        function ca(a) {
            ...
            H(a);
            var f = d.y > (a.inInlineMode ? b.editable.top + b.editable.height / 2 : Math.min(b.editable.height, b.pane.height) / 2), c = c[f ? "getLast" : "getFirst"](function(a) { return!(E(a) || F(a)) });
            if (!c)return null;
                ...
                a.addCommand("pastefromword", {
                    ...
                    exec: function(a) {
                        ...
                        a.getClipboardData({ title: a.lang.pastefromword.title }, function(c) {
                            c && a.fire("paste",
                            { type: "html", dataValue: c.dataValue, method: "paste", dataTransfer: CKEDITOR.plugins.clipboard.initPasteDataTransfer() });
            ...
            removeformat: {
                exec: function(a) {
                    for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), e = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, m = a.getSelection().getRanges(), n = m.createIterator(), p = function(a) { return a.type == CKEDITOR.NODE_ELEMENT }, c; c = n.getNextRange();) {
                        ...
                        var l = c.createBookmark(), b = l.startNode, d = l.endNode, k = function(b) { for (var c = a.elementPath(b), e = c.elements, d = 1, g; (g = e[d]) && !g.equals(c.block) && !g.equals(c.blockLimit); d++)h.test(g.getName()) && f(a, g) && b.breakParent(g) };
                        k(b);
                        if (d)
                            for (k(d), b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); b && !b.equals(d);)
                                if (b.isReadOnly()) {
                                    ...
                                    k = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == b.getName() && b.data("cke-realelement") || !f(a, b) || (h.test(b.getName()) ?
    ...
    (function() {
        ...
        function m(e, d) {
            ...
            for (h = 0; h < g; h++)
                c[h] && (1 < c[h].colSpan && b[h] == c[h] ? (a = c[h], a.colSpan += 1) : (a = (new CKEDITOR.dom.element(c[h])).clone(),
