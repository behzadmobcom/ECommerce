...
namespace Services.Services
{
    public class StarService : EntityService<ProductUserRank>, IStarService
    {
        ...
        public async Task<string> SaveStars(int productId, int starNumber, string productUrl)
        {
            ...
            if ( currentUser.Id == 0)
            {
                return "برای امتیاز دادن ابتدا لاگین کنید";
            }
            ...
            return result.Code == 0 ? "امتیاز شما با موفقیت ذخیره شد" : "متاسفانه امتیاز شما ذخیره نشده. به پشتیبانی سایت اطلاع دهید";
        }
