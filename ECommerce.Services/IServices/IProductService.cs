...
{
    Task<ServiceResult<ProductViewModel>> GetProduct(string productUrl,int? userId ,bool isWithoutBill = true, bool isCheckExist = false);
    ...
    Task<ServiceResult<List<ProductViewModel>>> GetAll();
